...
function nameChoice(input) {
    ...
    let percName
    if(input == 'Эдисон' || input == 'Бишка' || input == 'Икс Данил' || input == 'Клайп' || input == 'Херейд'){
        switch (input){
            case 'Эдисон':
                userFoto.src = './images/эдисон.png'
                percName = 'Эдисон слева'
            break;
            case 'Бишка':
                userFoto.src = './images/бишка.png'
                percName = 'Бишка слева'
            break;
            case 'Икс Данил':
                userFoto.src = './images/иксданил.png'
                percName = 'Икс Данил слева'
            break;
            case 'Клайп':
                userFoto.src = './images/клайп.png'
                percName = 'Клайп слева'
            break;
            case 'Херейд':
                userFoto.src = './images/херейд.png'
                percName = 'Херейд слева'
            break;
            default:
            break;
        }
    ...
    }else if(input == 'Эдисoн' || input == 'Херeйд' || input == 'Бишкa' || input == 'Клaйп' || input == 'Икс Дaнил'){
        switch (input){
            case 'Эдисoн':
                opponentFoto.src = './images/эдисон справа.png'
                percName = 'Эдисон справа'
            break;
            case 'Херeйд':
                opponentFoto.src = './images/херейд справа.png'
                percName = 'Херейд справа'
            break;
            case 'Бишкa':
                opponentFoto.src = './images/бишка справа.png'
                percName = 'Бишка справа' 
            break;
            case 'Клaйп':
                opponentFoto.src = './images/клайп справа.png'
                percName = 'Клайп справа'
            break;
            case 'Икс Дaнил':
                opponentFoto.src = './images/иксданил справа.png'
                percName = 'Икс Данил справа' 
            break;
            default:
            break;
        }
