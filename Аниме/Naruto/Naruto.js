...
function nameChoice(input) {
    ...
    let percName
    if(input == 'Naruto' || input == 'Kakashi' || input == 'Hashirama'){
        switch (input){
            case 'Naruto':
                userFoto.src = './images/naruto.jpg'
                percName = 'Naruto'
            break;
            case 'Kakashi':
                userFoto.src = './images/какаши.jpg'
                percName = 'Kakashi'
            break;
            case 'Hashirama':
                userFoto.src = './images/хаширама.jpg'
                percName = 'Hashirama'
            break;
            default:
            break;
    ...
    }else if(input == 'Madara' || input == 'Obito' || input == 'Saske'){
        switch (input){
            case 'Madara':
                opponentFoto.src = './images/мадара.jpg'
                percName = 'Madara'
            break;
            case 'Obito':
                opponentFoto.src = './images/обито.png'
                percName = 'Obito'
            break;
            case 'Saske':
                opponentFoto.src = './images/саске.png'
                percName = 'Saske' 
            break;
            default:
            break;
