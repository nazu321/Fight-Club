...
function nameChoice(input) {
    ...
    let percName
    if(input == 'Luffy' || input == 'Zoro' || input == 'Edward' || input == 'Lo' || input == 'Rodger'){
        switch (input){
            case 'Luffy':
                userFoto.src = './images/луфи.jpg'
                percName = 'Luffy'
            break;
            case 'Zoro':
                userFoto.src = './images/зоро.jpg'
                percName = 'Zoro'
            break;
            case 'Edward':
                userFoto.src = './images/эдвард.jpg'
                percName = 'Edward'
            break;
            case 'Lo':
                userFoto.src = './images/ло.jpg'
                percName = 'Lo'
            break;
            case 'Rodger':
                userFoto.src = './images/роджер.jpg'
                percName = 'Rodger'
            break;
            default:
            break;
    ...
    }else if(input == 'Kaido' || input == 'Lin Lin' || input == 'Akainu' || input == 'Marshal' || input == 'Doflamingo'){
        switch (input){
            case 'Kaido':
                opponentFoto.src = './images/кайдо.jpg'
                percName = 'Kaido'
            break;
            case 'Lin Lin':
                opponentFoto.src = './images/лин лин.jpeg'
                percName = 'Lin Lin'
            break;
            case 'Akainu':
                opponentFoto.src = './images/сакадзуки.jpg'
                percName = 'Akainu' 
            break;
            case 'Marshal':
                opponentFoto.src = './images/маршал.jpg'
                percName = 'Marshal'
            break;
            case 'Doflamingo':
                opponentFoto.src = './images/дофломинго.jpg'
                percName = 'Doflamingo' 
            break;
            default:
            break;
